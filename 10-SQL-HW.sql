USE sakila;
# 1a Display Actors' First and Last name 
SELECT first_name, last_name
FROM actor;

# 1b Create a Column to merge First and Last names name it Actorname in Upperletters
...
# 3b You want to keep a description of each actor. You don't think you will be performing queries 
#on a description, so create a column in the table actor named description and use the data 
# type BLOB (Make sure to research the type 
# BLOB, as the difference between it and VARCHAR are significant).

SELECT * FROM actor;
ALTER TABLE actor
ADD COLUMN  description BLOB(1000) AFTER last_name;
